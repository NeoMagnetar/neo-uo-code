    ...
    public static class AIGMCompanionCommandBoundary
    {
        ...
        private static readonly RecognizedCommandFamily[] CommandFamilies =
        {
            ...
            Create(AIGMCompanionCommandVerbKind.TrackReadOnly, AIGMCompanionCapabilityKind.TrackReadOnly, "track", false, true, false,
                exactMatches: new[] { "track animals", "track monsters", "track players", "track animal", "track monster", "track enemies", "track hostiles", "track npcs", "track npc", "track human npcs", "track humans", "track human", "track people", "scan animals", "scan monsters", "scan players" }),
            ...
            Create(AIGMCompanionCommandVerbKind.TrackingStatus, AIGMCompanionCapabilityKind.ReportTrackingStatus, "tracking status", false, true, false,
                exactMatches: new[] { "tracking status", "track status", "report tracking", "report tracking status", "what is your tracking status", "all tracking status" }),
