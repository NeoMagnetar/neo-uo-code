...
namespace Server.Custom.AIGM
{
    public sealed class AIGMCompanionDialogueEvent
    {
        ...
        public string TargetCompanionId { get; private set; }
        ...
        public AIGMCompanionDialogueEvent(Serial sourceCompanionSerial, Serial targetCompanionSerial, string sourceCompanionName, string targetCompanionName, string text, int hopCount)
            : this(sourceCompanionSerial, targetCompanionSerial, sourceCompanionName, targetCompanionName, null, text, hopCount)
        {
        }

        public AIGMCompanionDialogueEvent(Serial sourceCompanionSerial, Serial targetCompanionSerial, string sourceCompanionName, string targetCompanionName, string targetCompanionId, string text, int hopCount)
        {
            ...
            TargetCompanionId = targetCompanionId ?? String.Empty;
