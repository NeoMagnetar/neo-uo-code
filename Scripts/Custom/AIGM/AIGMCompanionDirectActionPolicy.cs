...
namespace Server.Custom.AIGM
{
    ...
    {
        public static AIGMCompanionActionPolicyResult Decide(BaseHire companion, Mobile speaker, AIGMCompanionIntent intent)
        {
        ...
        private static bool IsTrustedSpeaker(BaseHire companion, Mobile speaker)
        {
            ...
            return owner != null && ally != null && !ally.Deleted && ally != companion && ally.GetOwner() == owner;
        }

        private static AIGMExecutionMode GetExecutionMode(BaseHire companion)
        {
