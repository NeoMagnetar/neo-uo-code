				...
				case 0x01: // edit request
					{
						...
						// Paperdoll profile/journal text can legitimately be much larger than the
						// old stock 511-character guard, especially with modern clients.
						// The profile UI is still packet-bounded, so keep the cap high but below
						// the safe practical response size for a returned 0xB8 profile packet.
						if (length > 0x7800)
						{
							return;
						}
