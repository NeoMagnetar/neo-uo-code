    ...
    public class AIGMCompanionDakeyras : BaseHire
    {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && e.Mobile.InRange(this, 8))
            {
                ...
                LogSpeech("DAK_TRUST_RESULT trusted=" + trusted + " owner=" + SafeName(owner));

                if (trusted)
                {
                    if (normalizedSpeech == "runtime stamp" || normalizedSpeech == "version" || normalizedSpeech == "who are you")
                    {
