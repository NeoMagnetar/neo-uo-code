# Chain Armor Code Work

## Design Reference
Reference the matching page in the Neo UO repo armor wiki: `06_design/armor/families/chain-armor.md`.
...
## Neo UO Interest
important for medium-heavy survivability and burden tradeoff tuning.
