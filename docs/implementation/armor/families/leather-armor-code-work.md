# Leather Armor Code Work

## Design Reference
Reference the matching page in the Neo UO repo armor wiki: `06_design/armor/families/leather-armor.md`.
...
## Neo UO Interest
important for mobile survival builds, hunters, scouts, and wilderness play.
