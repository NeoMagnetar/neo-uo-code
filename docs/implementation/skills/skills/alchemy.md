...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/alchemy.md`.
...
## First Audit Task
Locate where `Alchemy` is declared and find the first behavior entry point tied to this skill.
