...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/anatomy.md`.
...
## Neo UO Interest
important for support identity and recovery-adjacent review later.

## First Audit Task
Locate where `Anatomy` is declared and find the first behavior entry point tied to this skill.
