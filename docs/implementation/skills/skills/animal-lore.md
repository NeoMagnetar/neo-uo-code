# Animal Lore Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/animal-lore.md`.
...
## Neo UO Interest
important for predator/prey design later.

## First Audit Task
Locate where `AnimalLore` is declared and find the first behavior entry point tied to this skill.
