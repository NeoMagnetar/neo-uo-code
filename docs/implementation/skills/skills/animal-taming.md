# Animal Taming Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/animal-taming.md`.
...
## Neo UO Interest
important for continuity, wilderness, and companion balance later.

## First Audit Task
Locate where `AnimalTaming` is declared and find the first behavior entry point tied to this skill.
