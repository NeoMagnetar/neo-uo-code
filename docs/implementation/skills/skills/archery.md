...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/archery.md`.
...
## Neo UO Interest
important for ranged combat identity and future arena readability.

## First Audit Task
Locate where `Archery` is declared and find the first behavior entry point tied to this skill.
