...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/begging.md`.
...
## Neo UO Interest
important as a legacy utility lane if social or odd-path progression expands later.

## First Audit Task
Locate where `Begging` is declared and find the first behavior entry point tied to this skill.
