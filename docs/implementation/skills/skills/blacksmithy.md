# Blacksmithy Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/blacksmithy.md`.
...
## Neo UO Interest
important for economy, logistics, and long-term character breadth.

## First Audit Task
Locate where `Blacksmith` is declared and find the first behavior entry point tied to this skill.
