# Bowcraft / Fletching Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/bowcraft-fletching.md`.
...
## Neo UO Interest
important for ranged supply, logistics, and crafting identity later.

## First Audit Task
Locate where `Fletching` is declared and find the first behavior entry point tied to this skill.
