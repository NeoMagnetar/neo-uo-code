...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/bushido.md`.
...
## First Audit Task
Locate where `Bushido` is declared and find the first behavior entry point tied to this skill.
