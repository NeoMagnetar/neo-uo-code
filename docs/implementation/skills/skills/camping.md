...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/camping.md`.
...
## Neo UO Interest
important if dangerous-world recovery and wilderness loops deepen later.

## First Audit Task
Locate where `Camping` is declared and find the first behavior entry point tied to this skill.
