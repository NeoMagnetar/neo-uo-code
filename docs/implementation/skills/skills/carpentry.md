...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/carpentry.md`.
...
## Neo UO Interest
important for economy, logistics, and non-metal craft breadth.

## First Audit Task
Locate where `Carpentry` is declared and find the first behavior entry point tied to this skill.
