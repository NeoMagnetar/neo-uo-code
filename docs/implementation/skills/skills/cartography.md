# Cartography Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/cartography.md`.
...
## Neo UO Interest
important if exploration, map knowledge, or expedition systems expand later.

## First Audit Task
Locate where `Cartography` is declared and find the first behavior entry point tied to this skill.
