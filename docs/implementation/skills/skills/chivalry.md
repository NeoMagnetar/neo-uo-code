...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/chivalry.md`.
...
## First Audit Task
Locate where `Chivalry` is declared and find the first behavior entry point tied to this skill.
