...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/cooking.md`.
...
## Neo UO Interest
important for logistics, survival loops, and support economy later.

## First Audit Task
Locate where `Cooking` is declared and find the first behavior entry point tied to this skill.
