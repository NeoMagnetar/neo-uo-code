# Discordance Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/discordance.md`.
...
## Neo UO Interest
important for control, disruption, and anti-zerg implications later.

## First Audit Task
Locate where `Discordance` is declared and find the first behavior entry point tied to this skill.
