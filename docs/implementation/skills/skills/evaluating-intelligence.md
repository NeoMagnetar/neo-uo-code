# Evaluating Intelligence Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/evaluating-intelligence.md`.
...
## Neo UO Interest
important for caster identity and spell-scaling review later.

## First Audit Task
Locate where `EvalInt` is declared and find the first behavior entry point tied to this skill.
