...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/fishing.md`.
...
## Neo UO Interest
important for gathering breadth and non-combat economy texture later.

## First Audit Task
Locate where `Fishing` is declared and find the first behavior entry point tied to this skill.
