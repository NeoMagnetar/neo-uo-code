...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/focus.md`.
...
## Neo UO Interest
important for sustain and slower-mastery resource pacing review later.

## First Audit Task
Locate where `Focus` is declared and find the first behavior entry point tied to this skill.
