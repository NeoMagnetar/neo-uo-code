...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/healing.md`.
...
## Neo UO Interest
core identity skill for recovery pacing.

## First Audit Task
Locate where `Healing` is declared and find the first behavior entry point tied to this skill.
