...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/herding.md`.
...
## Neo UO Interest
important if animal-control and wilderness systems expand later.

## First Audit Task
Locate where `Herding` is declared and find the first behavior entry point tied to this skill.
