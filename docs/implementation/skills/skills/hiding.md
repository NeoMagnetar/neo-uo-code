...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/hiding.md`.
...
## First Audit Task
Locate where `Hiding` is declared and find the first behavior entry point tied to this skill.
