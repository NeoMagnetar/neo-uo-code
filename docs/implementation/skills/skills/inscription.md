# Inscription Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/inscription.md`.
...
## Neo UO Interest
important for magic-adjacent crafting and long-lived character breadth.

## First Audit Task
Locate where `Inscription` is declared and find the first behavior entry point tied to this skill.
