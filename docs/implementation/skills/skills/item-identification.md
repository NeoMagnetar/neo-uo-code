# Item Identification Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/item-identification.md`.
...
## Neo UO Interest
important if hidden item knowledge or inspection friction is revisited later.

## First Audit Task
Locate where `ItemID` is declared and find the first behavior entry point tied to this skill.
