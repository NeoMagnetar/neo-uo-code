# Lumberjacking Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/lumberjacking.md`.
...
## Neo UO Interest
important for gathering economy and possible wilderness crossover later.

## First Audit Task
Locate where `Lumberjacking` is declared and find the first behavior entry point tied to this skill.
