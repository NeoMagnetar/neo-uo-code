# Mace Fighting Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/mace-fighting.md`.
...
## Neo UO Interest
important for melee family differentiation and disruption identity.

## First Audit Task
Locate where `Macing` is declared and find the first behavior entry point tied to this skill.
