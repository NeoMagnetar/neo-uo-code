...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/magery.md`.
...
## Neo UO Interest
important for combat identity and broad utility review later.

## First Audit Task
Locate where `Magery` is declared and find the first behavior entry point tied to this skill.
