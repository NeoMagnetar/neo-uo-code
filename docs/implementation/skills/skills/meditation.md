# Meditation Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/meditation.md`.
...
## Neo UO Interest
important for sustain and recovery pacing in caster progression.

## First Audit Task
Locate where `Meditation` is declared and find the first behavior entry point tied to this skill.
