# Musicianship Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/musicianship.md`.
...
## Neo UO Interest
important as the bardic foundation for later control and disruption review.

## First Audit Task
Locate where `Musicianship` is declared and find the first behavior entry point tied to this skill.
