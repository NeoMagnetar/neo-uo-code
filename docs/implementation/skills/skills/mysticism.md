...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/mysticism.md`.
...
## Neo UO Interest
important for combat identity and expansion-era combat expression.

## First Audit Task
Locate where `Mysticism` is declared and find the first behavior entry point tied to this skill.
