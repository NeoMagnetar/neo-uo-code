# Necromancy Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/necromancy.md`.
...
## Neo UO Interest
important for combat identity and dark utility expression later.

## First Audit Task
Locate where `Necromancy` is declared and find the first behavior entry point tied to this skill.
