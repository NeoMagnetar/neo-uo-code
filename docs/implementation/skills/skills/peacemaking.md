# Peacemaking Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/peacemaking.md`.
...
## First Audit Task
Locate where `Peacemaking` is declared and find the first behavior entry point tied to this skill.
