# Provocation Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/provocation.md`.
...
## First Audit Task
Locate where `Provocation` is declared and find the first behavior entry point tied to this skill.
