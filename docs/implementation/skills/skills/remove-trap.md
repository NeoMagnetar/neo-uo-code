# Remove Trap Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/remove-trap.md`.
...
## Neo UO Interest
important if trap ecosystems and dungeon utility become more meaningful later.

## First Audit Task
Locate where `RemoveTrap` is declared and find the first behavior entry point tied to this skill.
