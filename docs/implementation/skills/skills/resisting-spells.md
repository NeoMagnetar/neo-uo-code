# Resisting Spells Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/resisting-spells.md`.
...
## Neo UO Interest
important for magical counterplay and survival review later.

## First Audit Task
Locate where `MagicResist` is declared and find the first behavior entry point tied to this skill.
