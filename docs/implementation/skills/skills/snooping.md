...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/snooping.md`.
...
## Neo UO Interest
important for crime, information control, and rogue utility later.

## First Audit Task
Locate where `Snooping` is declared and find the first behavior entry point tied to this skill.
