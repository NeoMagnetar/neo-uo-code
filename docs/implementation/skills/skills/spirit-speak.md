# Spirit Speak Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/spirit-speak.md`.
...
## Neo UO Interest
important if occult utility and death-adjacent support systems are revisited later.

## First Audit Task
Locate where `SpiritSpeak` is declared and find the first behavior entry point tied to this skill.
