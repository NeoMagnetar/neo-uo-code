...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/stealing.md`.
...
## Neo UO Interest
important for rogue identity, law implications, and world risk design later.

## First Audit Task
Locate where `Stealing` is declared and find the first behavior entry point tied to this skill.
