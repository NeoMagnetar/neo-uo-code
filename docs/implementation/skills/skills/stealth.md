...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/stealth.md`.
...
## Neo UO Interest
important for evasion and wounded survival.

## First Audit Task
Locate where `Stealth` is declared and find the first behavior entry point tied to this skill.
