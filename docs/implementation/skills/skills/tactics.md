...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/tactics.md`.
...
## Neo UO Interest
important for physical combat identity and throughput review.

## First Audit Task
Locate where `Tactics` is declared and find the first behavior entry point tied to this skill.
