...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/tailoring.md`.
...
## First Audit Task
Locate where `Tailoring` is declared and find the first behavior entry point tied to this skill.
