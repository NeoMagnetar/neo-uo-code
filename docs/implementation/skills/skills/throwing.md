...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/throwing.md`.
...
## Neo UO Interest
important for expansion-era ranged identity and future niche combat review.

## First Audit Task
Locate where `Throwing` is declared and find the first behavior entry point tied to this skill.
