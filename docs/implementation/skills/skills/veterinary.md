# Veterinary Code Work

## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/veterinary.md`.
...
## Neo UO Interest
important if animal survivability or companion value changes later.

## First Audit Task
Locate where `Veterinary` is declared and find the first behavior entry point tied to this skill.
