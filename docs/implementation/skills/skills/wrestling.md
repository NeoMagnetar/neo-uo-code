...
## Design Reference
Reference: Neo UO design repo `06_design/skills/skills/wrestling.md`.
...
## Neo UO Interest
important for self-defense, caster survival, and close-control review later.

## First Audit Task
Locate where `Wrestling` is declared and find the first behavior entry point tied to this skill.
