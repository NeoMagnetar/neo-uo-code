# Fencing Weapons Code Work

## Design Reference
Reference the matching page in the Neo UO repo weapons wiki: `06_design/weapons/families/fencing-weapons.md`.
...
## Neo UO Interest
important for light-load combat identity, speed, precision, and hunter-style roles.
