# Wrestling and Unarmed Code Work

## Design Reference
Reference the matching page in the Neo UO repo weapons wiki: `06_design/weapons/families/wrestling-and-unarmed.md`.
...
## Neo UO Interest
important for fallback combat, stripped-state relevance, and capture/survival edge cases later.
