...
## Intent
Capture the arena rule "Decide facet law first, local arena law second" as a stable design and implementation tracking unit within the facet and map rules domain.
