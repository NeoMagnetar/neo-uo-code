...
## Intent
Capture the arena rule "Create staging room region" as a stable design and implementation tracking unit within the region geometry and boundaries domain.
