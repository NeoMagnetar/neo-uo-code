...
## Intent
Capture the arena rule "Define arena Z floor" as a stable design and implementation tracking unit within the region geometry and boundaries domain.
...
## Related Rules
- [Define arena rectangle](define_arena_rectangle.md)
