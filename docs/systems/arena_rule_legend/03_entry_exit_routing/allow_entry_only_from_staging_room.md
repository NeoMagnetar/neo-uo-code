...
## Intent
Capture the arena rule "Allow entry only from staging room" as a stable design and implementation tracking unit within the entry, exit, and routing domain.
