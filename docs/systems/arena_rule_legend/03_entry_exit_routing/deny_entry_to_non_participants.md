...
## Intent
Capture the arena rule "Deny entry to non-participants" as a stable design and implementation tracking unit within the entry, exit, and routing domain.
...
## Related Rules
- [Allow entry only from staging room](allow_entry_only_from_staging_room.md)
