...
## Intent
Capture the arena rule "Allow damage to summoned creatures" as a stable design and implementation tracking unit within the combat permissions domain.
...
## Related Rules
- [Deny pre-match aggression](deny_pre_match_aggression.md)
