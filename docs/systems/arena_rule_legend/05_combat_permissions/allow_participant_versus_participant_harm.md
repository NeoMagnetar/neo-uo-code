...
## Intent
Capture the arena rule "Allow participant-versus-participant harm" as a stable design and implementation tracking unit within the combat permissions domain.
