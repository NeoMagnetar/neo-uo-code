...
## Intent
Capture the arena rule "Deny outsider-versus-participant harm" as a stable design and implementation tracking unit within the combat permissions domain.
...
## Related Rules
- [Allow participant-versus-participant harm](allow_participant_versus_participant_harm.md)
