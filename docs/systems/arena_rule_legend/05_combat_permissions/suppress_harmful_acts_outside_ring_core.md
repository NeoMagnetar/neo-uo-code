...
## Intent
Capture the arena rule "Suppress harmful acts outside ring core" as a stable design and implementation tracking unit within the combat permissions domain.
