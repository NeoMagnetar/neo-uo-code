...
## Intent
Capture the arena rule "Remove aggressions at match start" as a stable design and implementation tracking unit within the criminal, guard, and legal state domain.
