...
## Intent
Capture the arena rule "Auto-dismiss summons on entry" as a stable design and implementation tracking unit within the pets, summons, and followers domain.
...
## Related Rules
- [Auto-stable pets on entry](auto_stable_pets_on_entry.md)
