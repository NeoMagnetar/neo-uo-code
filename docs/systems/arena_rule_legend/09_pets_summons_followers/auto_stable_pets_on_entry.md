...
## Intent
Capture the arena rule "Auto-stable pets on entry" as a stable design and implementation tracking unit within the pets, summons, and followers domain.
...
## Related Rules
- [Disable pets in bounds](disable_pets_in_bounds.md)
