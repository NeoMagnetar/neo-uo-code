...
## Intent
Capture the arena rule "Disable stealth in ring" as a stable design and implementation tracking unit within the mount, movement, and locomotion domain.
...
## Related Rules
- [Reveal on boundary cross](reveal_on_boundary_cross.md)
