...
## Intent
Capture the arena rule "Use whitelist-only ability sets" as a stable design and implementation tracking unit within the spell, skill, and special move domain.
...
- [Use blacklist-only ability sets](use_blacklist_only_ability_sets.md)
