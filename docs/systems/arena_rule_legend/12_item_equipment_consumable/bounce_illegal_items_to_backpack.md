...
## Intent
Capture the arena rule "Bounce illegal items to backpack" as a stable design and implementation tracking unit within the item, equipment, and consumable domain.
