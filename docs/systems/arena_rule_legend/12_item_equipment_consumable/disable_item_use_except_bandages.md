...
## Intent
Capture the arena rule "Disable item use except bandages" as a stable design and implementation tracking unit within the item, equipment, and consumable domain.
...
- [Disable scroll use](disable_scroll_use.md)
