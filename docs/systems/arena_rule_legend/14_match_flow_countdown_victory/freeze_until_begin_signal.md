...
## Intent
Capture the arena rule "Freeze until begin signal" as a stable design and implementation tracking unit within the match flow, countdown, and victory domain.
