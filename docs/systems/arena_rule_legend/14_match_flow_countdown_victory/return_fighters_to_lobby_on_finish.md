...
## Intent
Capture the arena rule "Return fighters to lobby on finish" as a stable design and implementation tracking unit within the match flow, countdown, and victory domain.
...
- [Lock the ring while results display](lock_the_ring_while_results_display.md)
