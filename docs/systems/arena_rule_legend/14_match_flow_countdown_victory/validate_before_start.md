...
## Intent
Capture the arena rule "Validate before start" as a stable design and implementation tracking unit within the match flow, countdown, and victory domain.
...
## Related Rules
- [Require ready-check](require_ready_check.md)
