...
## Intent
Capture the arena rule "Disable healing in sudden death" as a stable design and implementation tracking unit within the anti-stall and sudden death domain.
...
- [Increase damage in sudden death](increase_damage_in_sudden_death.md)
