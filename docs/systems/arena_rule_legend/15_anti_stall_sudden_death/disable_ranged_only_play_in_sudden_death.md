...
## Intent
Capture the arena rule "Disable ranged-only play in sudden death" as a stable design and implementation tracking unit within the anti-stall and sudden death domain.
...
## Related Rules
- [Disable mounts in sudden death](disable_mounts_in_sudden_death.md)
