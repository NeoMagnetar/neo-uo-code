...
## Intent
Capture the arena rule "Trigger round-start broadcast" as a stable design and implementation tracking unit within the environment, hazard, and atmosphere domain.
...
## Related Rules
- [Trigger announcer speech on entry](trigger_announcer_speech_on_entry.md)
