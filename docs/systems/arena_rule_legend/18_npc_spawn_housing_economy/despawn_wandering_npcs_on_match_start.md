...
## Intent
Capture the arena rule "Despawn wandering NPCs on match start" as a stable design and implementation tracking unit within the npc, spawn, housing, and economy domain.
