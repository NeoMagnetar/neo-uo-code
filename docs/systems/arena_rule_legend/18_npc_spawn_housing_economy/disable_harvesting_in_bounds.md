...
## Intent
Capture the arena rule "Disable harvesting in bounds" as a stable design and implementation tracking unit within the npc, spawn, housing, and economy domain.
