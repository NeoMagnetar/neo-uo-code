...
## Intent
Capture the arena rule "Keep reward vendors outside ring only" as a stable design and implementation tracking unit within the npc, spawn, housing, and economy domain.
