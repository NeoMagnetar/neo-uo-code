...
## Intent
Capture the arena rule "Close arena gumps on finish" as a stable design and implementation tracking unit within the login, logout, stuck, and persistence domain.
