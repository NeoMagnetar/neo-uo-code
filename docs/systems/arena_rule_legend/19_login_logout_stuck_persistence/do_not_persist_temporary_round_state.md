...
## Intent
Capture the arena rule "Do not persist temporary round state" as a stable design and implementation tracking unit within the login, logout, stuck, and persistence domain.
