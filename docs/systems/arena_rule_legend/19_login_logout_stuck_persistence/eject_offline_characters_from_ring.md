...
## Intent
Capture the arena rule "Eject offline characters from ring" as a stable design and implementation tracking unit within the login, logout, stuck, and persistence domain.
