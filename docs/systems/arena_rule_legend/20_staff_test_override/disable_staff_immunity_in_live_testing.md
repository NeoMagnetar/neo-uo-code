...
## Intent
Capture the arena rule "Disable staff immunity in live testing" as a stable design and implementation tracking unit within the staff, test, and override domain.
...
- [Log all staff arena interventions](log_all_staff_arena_interventions.md)
