...
$serverRoot = 'C:\UO\Server\Neo Ultima Online\NeoUO-Dev'
$serverExe = Join-Path $serverRoot 'ServUO.exe'
$serverPort = 2594
$serverTitle = 'NeoUO Dev Server'
...
$envSettings = Join-Path $clientRoot 'settings.dev.json'
...
if (-not (Test-PortListening $serverPort)) { throw 'NeoUO Dev server did not start on port 2594.' }
